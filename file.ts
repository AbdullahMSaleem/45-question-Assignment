...
let current_users: string[] = ["John", "Alice", "Bob", "mary", "Steve"];
let new_users: string[] = ["john", "Alice", "George", "michael", "steve"];
...
function Buiild_paint(size: string = "L", message: string = "I love TypeScript") {
    console.log(`The size of the shirt is ${size} and the message on it is ${message}.`);
}
...
//44: Sandwiches: Write a function that accepts a array of items a person wants on a sandwich. The function should have one parameter that collects as many items as the function call provides, and it should print a summary of the sandwich that is being ordered. Call the function three times, using a different number of arguments each time.
 ...
 function sandwich(item1: string, item2?: string, item3?: string, item4?: string, item5?: string) {
     let sandwich = [item1, item2, item3, item4, item5];
...
// 45:Cars: Write a function that stores information about a car in a Object. The function should always receive a manufacturer and a model name. It should then accept an arbitrary number of keyword arguments. Call the function with the required information and two other name-value pairs, such as a color or an optional feature. Print the Object that’s returned to make sure all the information was stored correctly.
 ...
 function car(manufacturer: string, model: string, color?: string, feature?: string) {
     let car = {
