...
let message: string= `"${famousperson} once  said,"A person who  never made a mistake never tried something new."`;
console.log(message);
...
let Names: string[] = ["Abdullah", "Mohammed", "Ahmad", "Mahmoud"];
console.log(Names[0]);
console.log(Names[1]);
console.log(Names[2]);
console.log(Names[3]);
...
let transportation: string[] = ["car", "motorcycle", "bike", "bus"];
...
let guestlist: string[] = ["Abdullah", "Mohammed", "Ahmad", "Mahmoud"];

for (let guest of guestlist) {
    console.log(`Hello my friend ${guest} would you like to have dinner with me tonight`);
}
...
let Guests: string[] = ["Abdullah", "Mohammed", "Ahmad", "Mahmoud"];
...
let guests: string[] = ["Abdullah", "Mohammed", "Ahmed"];
...
let gues_ts: string[] = ["Abdullah", "Munafullah", "Ahmed"];

guests.unshift("Mohammed");
guests.push("Ahrad");
guests.splice(2,0,"waqas");
guests.forEach(guest => {
    console.log(`Dear ${guest}, would you like to have dinner with us today?`);
});